...
object JsonData {
  ...
  val serviceDetailsData =
    s"""
       ...
       |          "name": "jenkins",
       |		       "displayName": "Jenkins",
       |          "url": "https://deploy-dev.tax.service.gov.uk/job/deploy-microservice"
       |        }, {
       |          "name": "grafana",
       |		       "displayName": "Grafana",
       |          "url": "https://grafana-dev.tax.service.gov.uk/#/dashboard"
       |        }]
       |       }, {
       |        "name" : "QA",
       |        "services" : [{
  ...
  val prototypeDetailsData =
    s"""
       ...
       |    "url": "https://github.tools.tax.service.gov.uk/HMRC/2fa-prototype"
       |  }
       |  ],
       |  "ci": [ ],
       |  "environments": [ ]
